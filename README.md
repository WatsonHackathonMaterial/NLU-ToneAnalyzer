...
1. [Node Red NLU app](https://github.com/jeancarl/node-red-labs/blob/master/node-red-natural-language-understanding/node-red-natural-language-understanding.pdf)

2. [Build a smart email support app](https://github.com/IBM/smart-email-support)

# Tone Analyzer Code Patterns

1. [Create a mobile app that analyzes emotions](https://developer.ibm.com/patterns/tone-analyzer-for-ios/)
